            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: const[
                    Text('Privacy Policy',style: TextStyle(fontSize: 25.0,fontWeight: FontWeight.bold,color: Color(0xff234777)),),
                  ],
                ),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  Expanded(child: Text(title1,style:const  TextStyle(fontSize: 15.0,fontWeight: FontWeight.bold,color: Color(0xff234777)),)),
                ],
              ),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  Expanded(child: Text(title2,style:const  TextStyle(fontSize: 15.0,fontWeight: FontWeight.bold,color: Color(0xff234777)),)),
                ],
              ),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  Expanded(child: Text(title3,style:const  TextStyle(fontSize: 15.0,fontWeight: FontWeight.bold,color: Color(0xff234777)),)),
                ],
              ),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  Expanded(child: Text(heading3,style:const  TextStyle(fontSize: 10.0,color: Color(0xff234777)),)),
                ],
              ),
              const SizedBox(height: 10.0,),                
              Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  Expanded(child: Text(title4,style:const  TextStyle(fontSize: 15.0,fontWeight: FontWeight.bold,color: Color(0xff234777)),)),
                ],
              ),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  Expanded(child: Text(heading4,style:const  TextStyle(fontSize: 10.0,color: Color(0xff234777)),)),
                ],
              ),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  Expanded(child: Text(title5,style:const  TextStyle(fontSize: 15.0,fontWeight: FontWeight.bold,color: Color(0xff234777)),)),
                ],
              ),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  Expanded(child: Text(heading5,style:const  TextStyle(fontSize: 10.0,color: Color(0xff234777)),)),
                ],
              ),
